...
import Fundida1 from "../assets/industrial/linhaindustrial1.jpg";
import Fundida2 from "../assets/industrial/linhaindustrial2.jpg";
...
const PRODUCTS = {
  products: [
    {
      name: "Caçarola Industrial",
      name1: "Cacarola Industrial",
      image_url: Fundida1,
    },
    {
      name: "Caldeirão Industrial",
      name1: "Caldeirao Industrial",
      image_url: Fundida2,
    },
  ],
};
